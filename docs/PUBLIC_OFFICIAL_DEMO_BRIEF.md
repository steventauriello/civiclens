...
- Port St. Lucie pilot interface.
- FY 2024-25 operating-funds revenue and spending snapshot sourced from an official City report.
- Department spending tracker scaffold for mapping public money to departments and functions.
...
- It does not yet show vendor-level or invoice-level spending.
- It does not infer wrongdoing from missing records.
- It does not publish a number unless the source and calculation path are visible.
...
3. What calculation produced the public answer?
4. What is still missing?
5. What records should be requested next?

## Suggested feedback request

- Which public spending questions do residents ask most often?
...
1. Open the public dashboard overview.
2. Review the revenue and spending fund-level snapshot.
3. Open the department tracker and explain pending values.
4. Open the source registry.
5. Explain the Evidence Vault and publication rule: if we cannot trace it, we do not claim it.
