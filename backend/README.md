...
No application framework has been initialized yet. The reference architecture currently considers FastAPI or a TypeScript service layer, subject to an architecture decision record.
